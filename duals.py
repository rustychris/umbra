...
# The dual approach doesn't necessarily work, even when there
# is a solution?
# although, what if cells which include constrained nodes
# force all circumcenter calcs to use those nodes (and if they
# have at least 3 constrained nodes, then use only the constrained
# nodes? nope.
