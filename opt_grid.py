...
# First level - try some optimizations, make sure they don't
# wreak havoc on a grid which is already reasonable.
# at the same time, develop some base level
# interface / class structure for optimizations
