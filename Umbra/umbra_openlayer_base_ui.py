...
# Form implementation generated from reading ui file 'umbra_openlayer_base.ui'
#
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        Dialog.setWindowTitle(_translate("Dialog", "Open Umbra layer", None))
        self.formatCombo.setItemText(0, _translate("Dialog", "SUNTANS   {cells,edges,points}.dat", None))
        self.formatCombo.setItemText(1, _translate("Dialog", "SMS             *.grd", None))
        self.formatCombo.setItemText(2, _translate("Dialog", "DFlow FM *_net.nc", None))
